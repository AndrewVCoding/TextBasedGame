...
public class Player
{
	...
	//todo set up a system to put items from inventory into a Engine.Room's contents or a Engine.Container. It will work basically the same as adding to inventory but in reverse.
