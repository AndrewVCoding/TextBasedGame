...
public class ContentSlot
{
	...
	/**
	 * Creates a new Engine.ContentSlot to hold instances of an Engine.Entity
	 * @param entity the Engine.Entity you want to create a Engine.ContentSlot for
	 */
	...
	/**
	 * Creates a new Engine.ContentSlot to hold instances of an Engine.Entity
	 * @param key the  corresponding key of the Engine.Entity you want to create a Engine.ContentSlot for
	 */
	...
	/**
	 * Creates a new Engine.ContentSlot as an exact copy of another Engine.ContentSlot, containing the same instances
	 * @param contentSlot the Engine.ContentSlot you want to copy
	 */
	 ...
	 *
	 * @param input
	 * @return true if the NAME of the Engine.ContentSlot is found within the input
	 */
	 ...
	 *
	 * @param entity
	 * @return true if the entity's instance is listed in the Engine.ContentSlot
	 */
	 ...
	 *
	 * @param key
	 * @return true if the entity specified by the key is listed in the Engine.ContentSlot
	 */
	...
	/**
	 * Adds the instance to the list in the Engine.ContentSlot
	 * @param instance
	 */
	...
	/**
	 * Adds all instances of one Engine.ContentSlot to the list in this Engine.ContentSlot
	 * @param slot
	 */
	...
	/**
	 * Removes an entity's instance from Engine.ContentSlot
	 * @param entity
	 */
	...
	/**
	 * Removes an instance from the Engine.ContentSlot based on the key
	 * @param key
	 */
	...
	/**
	 * Returns the first Engine.Entity in the Engine.ContentSlot
	 * @return
	 */
	...
	/**
	 *
	 * @return the key of the top instance in the Engine.ContentSlot
	 */
	...
	{
		System.out.println("Engine.ContentSlot effect: " + index);
	}
}
