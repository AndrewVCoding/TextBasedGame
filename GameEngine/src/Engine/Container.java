...
public class Container extends Item
{
	...
	/**
	 * Displays a visual description of the Engine.Container and lists it's contents
	 */
	public void look()
	{
		if(OPEN)
	...
	/**
	 * displays the open description for the Engine.Container and sets it to open if unlocked
	 */
	public void open()
	{
		if(!LOCKED)
	...
	/**
	 * Displays the description for closing the Engine.Container and sets it to closed
	 */
	public void close()
	{
		if(OPEN)
	...
	/**
	 * @param entity
	 * @return true if the Engine.Entity is contained in the container
	 */
