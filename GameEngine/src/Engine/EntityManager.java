...
public class EntityManager
{
	...
	/**
	 * Add a new Engine.Entity to the game
	 *
	 * @param entity
	 */
	...
	/**
	 * Returns the Engine.Entity specified by ID:Instance
	 * @param idInstance
	 * @return
	 */
	...
	/**
	 * returns the specified instance of an Engine.Item
	 * @param idInstance
	 * @return
	 */
	...
	/**
	 * returns the specified instance of a Engine.Container
	 * @param idInstance
	 * @return
	 */
	...
	{
		StringBuilder output = new StringBuilder("Engine.EntityManager: ");
		for(InstanceManager im: INSTANCE_MANAGERS)
			output.append("\n").append(im.toString());
